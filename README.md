...
[ОБЩАЯ ИНСТРУКЦИЯ ПО CELERY](https://github.com/latuk993/amvera-fastapi-example/blob/main/CELERY.md) | [КАК ЗАПУСТИТЬ НА AMVERA](#деплой-в-amvera)
...
Полная схема подключения и пример отправки задачи описаны в общей [инструкции по Celery](https://github.com/latuk993/amvera-fastapi-example/blob/main/CELERY.md).
